...
**通过官网 Spring.io 中的[Spring Boot Reference Manual](https://docs.spring.io/spring-boot/docs/current-SNAPSHOT/reference/htmlsingle/) 搜索starters，可以看到很多启动器。**
...
@**SpringBootConfiguration**:Spring Boot的配置类(它是一个组合注解)
...
![Spring Initializer向导](images/QQ截图20180919171937.png)

选择我们需要的模块；向导会联网创建Spring Boot项目；

生成后，删除不需要的文件

![删除不需要的文件](images\QQ截图20180919172255.png)
